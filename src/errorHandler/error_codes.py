...
class codes:
    ...
    SMS_FAILED = handlerCode(505, "Sms failed", "The server did not receive a success response.")
    EMAIL_FAILED = handlerCode(506, "Email failed", "The server did not receive a success response.")
